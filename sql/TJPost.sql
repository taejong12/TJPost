...
CREATE TABLE ORDERS (
    ...
    ORDERS_STATUS VARCHAR(20) DEFAULT '결제완료' NOT NULL, -- 결제완료, 환불완료. 환불진행중
...
CREATE TABLE ORDERS_DETAIL (
    ...
    ORDERS_DETAIL_STATUS VARCHAR(20) DEFAULT '배송준비' NOT NULL, -- 배송준비, 배송중, 배송완료, 교환대기, 교환진행중, 환불진행중
...
CREATE TABLE REVIEW (
    ...
    REVIEW_CREATE DATE DEFAULT SYSDATE,
...
-- Q&A 테이블
CREATE TABLE Q&A (
    Q&A_ID NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY
);
