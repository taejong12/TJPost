    ...
    <div class="container mt-5 p-4 bg-light rounded shadow">
        ...
        <form action="/user/update" method="post">
            ...
            <div class="form-group mb-3">
                ...
                <input type="text" class="form-control form-control-lg" id="memberId" name="memberId" placeholder="아이디를 입력하세요" value="" readonly>
            ...
            <div class="form-group mb-3">
                ...
                <input type="password" class="form-control form-control-lg" id="memberPassword" name="memberPassword" placeholder="새 비밀번호를 입력하세요" required>
            ...
            <div class="form-group mb-3">
                ...
                <input type="text" class="form-control form-control-lg" id="memberName" name="memberName" placeholder="이름을 입력하세요" value="사용자의 현재 이름" required>
            </div>

            <!-- 이메일 입력 -->
            <div class="form-group mb-4">
                <label for="memberEmail" class="form-label fw-bold">이메일</label>
                <input type="email" class="form-control form-control-lg" id="memberEmail" name="memberEmail" placeholder="이메일을 입력하세요" value="사용자의 현재 이메일" required>
            </div>
