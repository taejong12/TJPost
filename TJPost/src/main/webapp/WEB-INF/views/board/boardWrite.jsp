		...
		<div class="container mt-5 p-4 bg-light rounded shadow">
		    ...
		    <form action="/board/write" method="post">
		        ...
		        <div class="form-group mb-4">
		            <label for="boardAuthor" class="form-label fw-bold">작성자</label>
		            <input type="text" class="form-control form-control-lg" id="boardAuthor" name="boardAuthor" placeholder="작성자를 입력하세요" required>
		        </div>
		        <div class="d-grid">
