...
<body>
	...
	<div class="container mt-5">
		...
		<div class="d-flex align-items-center gap-3 mb-3 justify-content-end">
		    <!-- 정렬 옵션 드롭다운 -->
		    <form id="sortForm" action="/admin/board/listPaging" method="get">
		    ...
		    <!-- 상품 개수 선택 -->
		    <form id="limitForm" action="/admin/board/listPaging" method="get">
			...
			<nav aria-label="Page navigation">
				<ul class="pagination">
		            ...
		            <c:if test="${currentPage > 1}">
		                <li class="page-item">
		                    <a class="page-link" href="/admin/board/listPaging?page=1&limit=${limit}&sort=${sort}">&laquo;&laquo;&laquo;</a>
		                </li>
		            </c:if>
		            ...
		            <c:if test="${startPage > 1}">
		                <li class="page-item">
		                    <a class="page-link" href="/admin/board/listPaging?page=${startPage - pageBlock}&limit=${limit}&sort=${sort}">&laquo;&laquo;</a>
		                </li>
		            </c:if>
					...
					<c:if test="${currentPage > 1}">
						<li class="page-item">
							<a class="page-link" href="/admin/board/listPaging?page=${currentPage - 1}&limit=${limit}&sort=${sort}">&laquo;</a>
						</li>
					</c:if>
					...
					<c:forEach var="i" begin="${startPage}" end="${endPage}">
						<li class="page-item ${currentPage == i ? 'active' : ''}">
							<a class="page-link" href="/admin/board/listPaging?page=${i}&limit=${limit}&sort=${sort}">${i}</a>
						</li>
					</c:forEach>
					...
					<c:if test="${currentPage < totalPage}">
						<li class="page-item">
							<a class="page-link" href="/admin/board/listPaging?page=${currentPage + 1}&limit=${limit}&sort=${sort}">&raquo;</a>
						</li>
					</c:if>
		            ...
		            <c:if test="${endPage < totalPage}">
		                <li class="page-item">
		                    <a class="page-link" href="/admin/board/listPaging?page=${startPage + pageBlock}&limit=${limit}&sort=${sort}">&raquo;&raquo;</a>
		                </li>
		            </c:if>
